...
export default function ProjectCard({ name, category, summary, tech, metrics }: ProjectCardProps) {
  return (
    <article className="group holo-border rounded-[1.75rem] border border-cyan/10 bg-white/5 p-6 shadow-panel backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-cyan/35 hover:bg-white/8">
